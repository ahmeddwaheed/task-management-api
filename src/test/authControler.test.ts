...
describe('Auth Controller', () => {
  ...
  describe('registerUser', () => {
    ...
    it('should handle errors during registration', async () => {
      ...
      jest.fn<() => Promise<never>>().mockRejectedValue(new Error('Username already exists'));
  ...
  describe('loginUser', () => {
    it('should login the user and return a token with a 200 status', async () => {
      ...
      (authService.loginUser as jest.MockedFunction<typeof authService.loginUser>)
    ...
    it('should handle errors during login', async () => {
      ...
      jest.fn<() => Promise<never>>().mockRejectedValue(new Error('Invalid credentials'));
